...
- El **panel de contexto**: Instrucciones + base de conocimiento + la carpeta que el usuario concedió con el **explorador de archivos del sistema**.

![Panel de contexto del Project](images/context.png)

- Seguridad: Cowork no tiene acceso a nada fuera de esa carpeta, así que la carpeta ES el control de privacidad. **Nunca datos sensibles, credenciales o NDA.**
