# Cómo se resolvería la misión "Faro" en OpenAI Codex
...
|---|---|---|---|---|
| 1 | **Project** (base de Faro) | "Projects" en la GUI, apuntado a `Documentos/Faro-Mercado` | Project en la app de Codex, ligado a una carpeta/repo en disco | ✅ Directo |
| 2 | **Instructions** (contrato de Faro: empresas, tono, regla de oro "no es asesoramiento") | Campo "Instrucciones" del proyecto (GUI, sin archivo) | Archivo **`AGENTS.md`** en la raíz de la carpeta (texto, commiteable) | ✅ Directo (vía archivo) |
