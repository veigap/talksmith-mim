...
2. Conectar **MT Newswires** (el proveedor de noticias al que tenemos suscripción) desde el **directorio de conectores**: buscarlo, darle Connect y autorizar. → [MT Newswires](https://www.mtnewswires.com)
...
**🏁 Lo lográs cuando:** una corrida de la tarea, punta a punta y sin tocar nada, deja las fuentes en disco, el reporte en el Project y el borrador en Gmail.
...
> ✅ **Necesitás para este milestone:** **Code execution** habilitado (Settings → Capabilities). Y el aviso de clase: después de crear una Skill hay que darle **Save / enable** en Customize → Skills, o parece que "no funciona".
...
5. **Para llevarse pensado:** si esto lo usara todo el equipo, las Skills viajarían dentro de un **Plugin**; si una sub-tarea fuera pesada, iría a un **Subagente**. Quedan como siguiente paso fuera de la misión.
