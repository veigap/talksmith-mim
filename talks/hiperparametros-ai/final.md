...
![La misma pregunta produce dos respuestas distintas por perillas ocultas de configuración](images/s1-1-1-misma-pregunta-dos-respuestas.png)
<!-- ascii-source:
...
![El modelo arma una lista de palabras candidatas con un puntaje de confianza y elige una](images/s2-1-1-candidatos-con-confianza.png)
<!-- ascii-source:
  "El cielo es ___"
...
![La palabra final sale de una ruleta ponderada por confianza, no siempre la más probable](images/s2-2-1-ruleta-ponderada.png)
<!-- ascii-source:
...
![Temperatura baja concentra la elección; temperatura alta aplana la distribución](images/s3-1-1-temperatura-baja-vs-alta.png)
<!-- ascii-source:
...
![Top-p recorta la cola larga de candidatos improbables y conserva el núcleo que suma p](images/s3-2-1-top-p-recorta-cola.png)
<!-- ascii-source:
...
![Eje capacidad vs costo y latencia entre modelo mini, intermedio y grande o flagship](images/s5-1-1-capacidad-vs-costo.png)
<!-- ascii-source:
  CAPACIDAD  ^
...
![Parámetros de entrenamiento fijados por el constructor vs parámetros de inferencia tocables al usar](images/s6-1-1-entrenar-vs-usar.png)
<!-- ascii-source:
...
![El tamaño del modelo es la cantidad de parámetros: chico pocos, grande muchos](images/s6-2-1-tamano-parametros.png)
<!-- ascii-source:
...
![Learning rate como tamaño de paso al descender: pasos grandes rebotan, pasos chicos son lentos pero estables](images/s6-3-1-learning-rate-paso.png)
<!-- ascii-source:
