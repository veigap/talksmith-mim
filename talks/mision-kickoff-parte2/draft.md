...
class: "Misión Faro — kickoff · Parte 2"
research: research/corpus/
description: Slides are grouped into Sections. Each Section contains one or more Slides.
presenter: Paulo Veiga · Marco Sánchez Sorondo · Claudio Righetti · Juan Pablo Cosentino
audience: Estudiantes del Master in Management (MiM), IAE Business School. Perfil de gestión y negocios, mayormente no técnico; ya resolvieron la Parte 1.
duration: 10 min
date: Julio 2026
---
...
![Boceto del jefe: el tablero que quiere](images/mockup-tablero.png)
