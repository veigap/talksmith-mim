...
Reuse existing tags before inventing new ones. In use: restructure, add-slide, add-visual, visual, slide-content, sources, roadmap, positioning, compact, accuracy, too-dense, expand, too-vague, rewrite, bad-order, terminology, style, audience, split, redundancy, cut.
