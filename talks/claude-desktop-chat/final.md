...
![Las cuatro herramientas de Claude](images/s1-4-1-cuatro-herramientas-claude.png)
<!-- ascii-source:
...
![Chat solo frente a chat con conectores](images/s3-1-1-chat-solo-vs-conectores.png)
<!-- ascii-source:
...
![Un conector funciona en dos direcciones: leer y actuar](images/s3-2-1-conector-dos-direcciones.png)
<!-- ascii-source:
...
![Respuesta de memoria frente a respuesta con Web Search](images/s3-3-1-memoria-vs-busqueda.png)
<!-- ascii-source:
...
![Claude in Chrome en un panel al costado de la página](images/s3-4-1-claude-in-chrome.png)
<!-- ascii-source:
...
![Denominador común de los casos de uso de Claude in Chrome](images/s3-5-1-denominador-comun-chrome.png)
<!-- ascii-source:
...
![Cómo funciona el prompt injection en tres pasos](images/s3-6-1-prompt-injection.png)
<!-- ascii-source:
...
![Conectores out of the box y externos](images/s3-7-1-out-of-the-box-externos.png)
<!-- ascii-source:
                  CONECTORES
                       |
        +--------------+---------------+
...
![Flujo de una llamada a un conector externo por MCP](images/s3-9-1-flujo-mcp-externos.png)
<!-- ascii-source:
...
![Ciclo de un Schedule: disparador, ejecución y entrega](images/s4-1-1-ciclo-schedule.png)
<!-- ascii-source:
...
![Dónde corre un Schedule: local o nube](images/s4-2-1-local-vs-nube.png)
<!-- ascii-source:
...
Primera placa de misión, corta. Hasta acá se vieron capacidades sueltas: conectores, capacidad ejecutiva, Schedule, todo dentro del chat que la audiencia ya tiene y sin instalar nada. Esta slide le pone un destino concreto a lo aprendido. Presentar a Faro en dos frases: el analista de mercado virtual de Atlas, que sigue la actualidad del sector, consolida un reporte semanal y deja el borrador de correo listo antes de la reunión del lunes. Decir con qué se resuelve la parte 1: solo con el chat, los conectores y Schedule, sin instalar nada. Aclarar que la parte 2 se resuelve en la segunda clase, ya en Cowork, y que no depende de esta. Es la última lámina de la clase: cerrar acá, dejar la consigna de la parte 1 y anunciar que la próxima arranca con Cowork instalado. Tiempo objetivo: ~2 min.
...
- **Duración de esta clase sin confirmar (2026-07-31):** el frontmatter dice `60 min (a confirmar)`. La suma de los "Tiempo objetivo" de las 18 slides da ~50 min sin Q&A ni pausa; confirmar con el presentador el bloque real y ajustar el frontmatter.
